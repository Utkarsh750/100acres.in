        ...
        <div className="container mx-auto p-6 grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white shadow-md rounded-lg p-8">
            ...
            <p className="text-gray-700 mb-4">
              ...
              growing in the upper stages of real estate. The Dwarka Expressway
              is a major arterial road that connects Gurgaon with Delhi.
              Signature Deluxe DXP is spread over 17.5 acres of land. Signature
              New Launch Highrise Sector 37D residential projects are very
              lavish and provide you with a great opportunity to live a
              delightful lifestyle. The project aims to provide massive
              amenities with a spacious, comfortable interior as well as a
              high-quality immoderate area.
            </p>
          </div>
